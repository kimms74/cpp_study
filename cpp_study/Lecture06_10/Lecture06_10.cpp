...
int main()
{
    //char name[] = "Jack Jack";          // name[]은 array이기때문에 literal을 담을 수 있다
    ...
    //cout << uintptr_t(name) << endl;  //char type의 변수는 문자열을 보여주므로 uintptr_t를 사용하여 pointer를 나타내야한다
    ...
    cout << typeid(&c).name() << endl;      //char * // 문자열이라고 인식한다
